    ...
    <section className="dashboard-hero overflow-hidden rounded-[34px] border border-white/75 px-5 py-6 text-[var(--dashboard-hero-ink)] shadow-[0_28px_90px_rgba(17,24,39,0.12)] md:px-8 md:py-8">
      ...
      <div className="relative z-10 flex flex-col gap-8 xl:flex-row xl:items-end xl:justify-between">
        <div className="max-w-3xl">
          {eyebrow ? (
            <p className="dashboard-eyebrow text-white/70">{eyebrow}</p>
          ) : null}
...
export function DashboardSection({
  ...
  return (
    <section
      className={cn('dashboard-panel rounded-[28px] p-5 md:p-6', className)}
    >
...
export function DashboardStatCard({
  ...
  return (
    ...
    >
      ...
      <p className="mt-3 text-xl font-semibold leading-none md:text-2xl">
        {value}
      </p>
      {detail ? (
