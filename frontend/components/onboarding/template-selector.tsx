...
const templates = [
  {
    ...
    preview: ["Hero storytelling", "Feature-led product rows", "Magazine rhythm"],
  },
  {
    id: "market-grid",
    name: "Market Grid",
  ...
  },
  {
    ...
    preview: ["Modular sections", "Responsive deal panels", "Flexible product blocks"],
  },
];
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-3">
          {templates.map((template, index) => (
            ...
            >
              <div className={`bg-gradient-to-br ${template.palette} p-6 text-white`}>
